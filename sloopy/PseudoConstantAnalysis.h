...
public:
  ...
  bool isPseudoConstant(const ValueDecl *VD, const Stmt *Allowed=NULL);
  bool wasReferenced(const ValueDecl *VD);
...
private:
  ...
  std::map<const ValueDecl*, std::vector<const Stmt*>> Edits;
};
